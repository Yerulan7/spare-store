...
<body>
    ...
    <main class="page lanidng-page">
        ...
        <section class="portfolio-block block-intro" style="height: 400px;padding-top: 50px;padding-bottom: 50px;">
            <div class="container" style="margin-top: 0px;"><img src="assets/img/icons/automobile%20(1).png">
                <div class="about-me">
                    <p>Hello! It is a car spare shop.</p>
                </div>
            </div>
        </section>
        <section class="portfolio-block photography">
            <div class="container" style="height: 280px;">
                <div class="row no-gutters">
                    <div class="col-md-6 col-lg-4 item zoom-on-hover" style="text-align: right;color: rgb(255,255,255);background: rgb(255,255,255);height: 300px;"><a href="#"><img class="img-fluid image" src="assets/img/icons/automobile%20(2).png" style="background: #ffffff;padding-top: 20px;"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover" style="text-align: center;background: rgb(255,255,255);"><a href="#"><img class="img-fluid image" src="assets/img/icons/car%20(2).png" style="background: #ffffff;padding-top: 20px;"></a></div>
                    <div class="col-md-6 col-lg-4 item zoom-on-hover" style="text-align: left;background: rgb(255,255,255);"><a href="#"><img class="img-fluid image" src="assets/img/icons/strut%20(1).png" style="text-align: left;background: #ffffff;padding-top: 20px;"></a></div>
                </div>
            </div>
        </section>
        <section class="portfolio-block call-to-action border-bottom" style="height: 150px;">
            <div class="container">
                <div class="d-flex justify-content-center align-items-center content">
                    <h3>Looking for a car part?</h3><button class="btn btn-outline-primary btn-lg" type="button">Search</button></div>
            </div>
        </section>
